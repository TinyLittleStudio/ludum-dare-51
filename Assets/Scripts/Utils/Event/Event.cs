...
namespace TinyLittleStudio.LudumDare51.PROJECT_NAME
{
    public class Event
    {
        ...
        public static void Inject(string id, EventUtils.OnEvent onEvent)
        {
            Handle.GetHandle().Inject(id, onEvent);
        }

        public static void Deject(string id, EventUtils.OnEvent onEvent)
        {
            Handle.GetHandle().Deject(id, onEvent);
        }
